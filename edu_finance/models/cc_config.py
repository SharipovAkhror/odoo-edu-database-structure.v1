...
class EduConfig(models.Model):
    ...
    lessons_per_module = fields.Integer(
        ...
        default=12,
        required=True,
        help='Number of lessons in one module'
    )
    ...
    partial_payment_lesson = fields.Integer(
        string='Partial Payment Deadline (Lesson #)',
        default=3,
        required=True,
        help='Student must pay partial amount by this lesson number'
    )
    ...
    full_payment_lesson = fields.Integer(
        ...
        default=5,
        required=True,
        help='Student must pay full module amount by this lesson number'
    )
